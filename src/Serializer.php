...
final class Serializer extends BaseSerializer
{
    ...
    public function normalize($data, $format = null, array $context = []):array|int|string
    {
    ...
    public function denormalize($data, $class, $format = null, array $context = []):array|int|string
    {
